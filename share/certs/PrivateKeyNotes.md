...
unlocked to sign the Lioncoin-Qt.app bundle.
...
allowing somebody to distribute a Lioncoin-Qt.app or lioncoin-qt-setup.exe with a valid
...
that the lioncoin-qt.exe file inside the installer had not been tampered with.
