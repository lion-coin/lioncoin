The following is a list of assets used in the lioncoin source and their proper attribution.
...
* License: MIT
* Site: [https://lioncointalk.org/index.php?topic=15276.0](https://lioncointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original lioncoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/lioncoin.icns, src/qt/res/src/lioncoin.svg,
	src/qt/res/src/lioncoin.ico, src/qt/res/src/lioncoin.png,
	src/qt/res/src/lioncoin_testnet.png, docs/lioncoin_logo_doxygen.png,
