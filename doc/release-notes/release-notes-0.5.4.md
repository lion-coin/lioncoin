Lioncoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/lioncoin/files/Lioncoin/lioncoin-0.5.4/
...
http://gitorious.org/lioncoin/lioncoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Lioncoin-Qt notifications under Growl 1.3.
Increase required age of Lioncoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxLioncoin properly when installing Lioncoin-Qt over it. (Windows)
