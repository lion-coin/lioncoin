Lioncoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/lioncoin/files/Lioncoin/lioncoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Lioncoin
...
New/changed settings (command-line or lioncoin.conf file)
--------------------------------------------------------
