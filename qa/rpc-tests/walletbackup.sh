...
B4ARGS="-datadir=$D4"
$LIONCOIND $LIONCOINDARGS $B4ARGS &
B4PID=$!
...
B3ARGS="-datadir=$D3"
$LIONCOIND $LIONCOINDARGS $B3ARGS &
B3PID=$!
...
function StartThree {
  $LIONCOIND $LIONCOINDARGS $B1ARGS &
  B1PID=$!
  $LIONCOIND $LIONCOINDARGS $B2ARGS &
  B2PID=$!
  $LIONCOIND $LIONCOINDARGS $B3ARGS &
  B3PID=$!
}
