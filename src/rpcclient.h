...
#ifndef _LIONCOINRPC_CLIENT_H_
#define _LIONCOINRPC_CLIENT_H_ 1
...
/** Show help message for lioncoin-cli.
 ...
 *
 * @note the argument can be removed once lioncoin-cli functionality is removed from lioncoind
 */
