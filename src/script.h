...
#ifndef H_LIONCOIN_SCRIPT
#define H_LIONCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CLioncoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Lioncoin always counted CHECKMULTISIGs
