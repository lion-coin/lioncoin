/* src/lioncoin-config.h.  Generated from lioncoin-config.h.in by configure.  */
/* src/lioncoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef LIONCOIN_CONFIG_H

#define LIONCOIN_CONFIG_H
...
#define PACKAGE_BUGREPORT "info@lioncoin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Lioncoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Lioncoin Core 0.9.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "lioncoin"
